...
const DetailsDialog = (props: Props) => {
  return (
    <Dialog>
      <DialogTrigger>
        <span className="flex items-center px-2 py-1 text-primary-foreground rounded-md bg-primary hover:bg-primary/90 transition-colors">
          What is this
      ...
      <DialogContent className="w-[70vw] max-w-[100vw] md:w-[50vw]">
        <DialogHeader>
          <DialogTitle className="text-2xl">Welcome to My Quiz App!</DialogTitle>
          <DialogDescription>
            
            <p className="my-2 mt-4 ">
              Are you tired of mundane and repetitive quizzes? Say goodbye to
              the ordinary and embrace the extraordinary with My Quiz App! Our
